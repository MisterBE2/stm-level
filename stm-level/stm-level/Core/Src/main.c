...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOD,
			LCD_PIN_1_Pin | LED_GREEN_Pin | LED_ORANGE_Pin | LED_RED_Pin
					| LED_BLUE_Pin | RES_Pin | DC_Pin | CS_Pin, GPIO_PIN_RESET);
	...
	/*Configure GPIO pins : LCD_PIN_1_Pin LED_GREEN_Pin LED_ORANGE_Pin LED_RED_Pin
	 LED_BLUE_Pin RES_Pin DC_Pin CS_Pin */
	GPIO_InitStruct.Pin = LCD_PIN_1_Pin | LED_GREEN_Pin | LED_ORANGE_Pin
			| LED_RED_Pin | LED_BLUE_Pin | RES_Pin | DC_Pin | CS_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
